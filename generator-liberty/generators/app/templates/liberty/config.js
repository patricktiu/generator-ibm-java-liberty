{
  "properties" : [
    ...
    {"name" : {{#has buildType 'maven'}}"package.file"{{/has}}{{#has buildType 'gradle'}}"packageFile"{{/has}}, "value" : {{#has buildType 'maven'}}"${project.build.directory}/${project.artifactId}-${project.version}.zip"{{/has}}{{#has buildType 'gradle'}}"\"${project.buildDir}/{{artifactId}}-${version}.zip\""{{/has}} },
